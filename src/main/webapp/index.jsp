...
<div class="shop-nav shop-index">
    ...
    <div class="shop-banner">
            ...
            <div class="product-list">
                <dl id="getIndexRoomType">
                    ...
                    <c:forEach var="roomType" items="${roomTypeList}">
                        <dd data-id="${roomType.id}"><a class="fly-case-active" href="/room/list/${roomType.id}"
                                       data-type="toRoomTypeList">${roomType.typename}</a></dd>
                    </c:forEach>
        ...
        <div class="layui-carousel" lay-filter="LAY-store-banner" id="LAY-store-banner" lay-anim lay-indicator="inside" >
            <div carousel-item>
                <div class="">
                    <div class="layui-container"><a href="javascript:;" target="_blank"> <img src="${pageContext.request.contextPath}/statics/front/images/2.jpg"
                                                                                              alt="酒店系统"> </a></div>
                </div>
                <div class="">
                    ...
                    <div class="layui-container">
                        ...
                        <div class="layui-row layui-col-space20">
                            ...
                            <c:forEach var="room" items="${roomList}">
                                <c:if test="${floor.id == room.floorid}">
